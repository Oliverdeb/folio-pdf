  ...
  return (
    <AppShell>
      <article className="mx-auto max-w-2xl px-4 py-10 sm:py-14">
        ...
        <p className="mt-3 text-muted">
          The public site records one count when you download a result (or lock a PDF in Outlook). That is the tool name
          only — not the document, not the password, not your name. A self-hosted copy can disable this by building
          without a GoatCounter site code.
        </p>
